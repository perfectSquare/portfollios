<template><div class='relative flex gap-x-12'>	
	<label ref='cssCheckboxRef' class='cssCheckbox relative inline-flex gap-x-[10px] hover:shadow pl-2 pr-2 items-center transition-all duration-200'>
		<input type="checkbox" name="test" v-model='cssModel'>		
		<span class="absolute top-[6px] left-[8px] flex items-center bg-white w-[15px] h-[15px]">
			<svg
	...
	<div class='text-[12px] flex items-center'>v-model: {{cssModel}}</div>	
